...
(function (global) {
    ...
    const COLONNES = {
        ...
        debitDevise:  ['debit en devise d origine', 'debit en devise'],
        creditDevise: ['credit en devise d origine', 'credit en devise'],
    ...
    function lireComptable(rows, mapping, opts) {
        ...
        for (const r of rows) {
            ...
            const brut = {
                ...
                tauxChange: utile(col(r, 'tauxChange')),
                debitDevise: utile(col(r, 'debitDevise')),
                creditDevise: utile(col(r, 'creditDevise')),
